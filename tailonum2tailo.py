...
parser.add_argument('--tailo_num_file', required=True, help='file in Tailo NUM form')
args = parser.parse_args()

tailo_file = args.tailo_num_file
epi = epitran.Epitran('temp-nan-num2tailo', tones=True)
